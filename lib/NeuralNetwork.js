class NeuralNetwork {
	constructor(config) {
		if (config instanceof NeuralNetwork) {
			...
			this.dActivationFunction = config.dActivationFunction;
			...
			if(config.activationFunction) {
				this.activationFunction = config.activationFunction.x;
				this.dActivationFunction = config.activationFunction.y;
			} else {
				this.activationFunction = this.sigmoid;
				this.dActivationFunction = this.dSigmoid;
			}
		}
